...
-- Generation Time: Jun 07, 2018 at 12:46 PM
...
INSERT INTO `Event_Volunteer` (`fk_event_id`, `fk_volunteer_id`, `status`) VALUES
(1, 1, '1'),
(1, 99999, NULL),
(2, 99999, NULL);
...
(1, 'password', 'volunteer@example.com', '5555555555', 'Some', 'Nice Guy'),
(99999, 'password', 'annonymous@example.com', '1111111111', 'annonymous', 'volunteer'),
(100000, 'password', 'bonhamj@oregonstate.edu', '1', 'John', 'Bonham'),
(100001, '123456', 'richtestman@gmail.com', '206-525-2525', 'Rich', 'Testman'),
(100002, '123456', 'markemark@gmail.com', '651-154-7845', 'Mark', 'EMark'),
(100003, '123456', 'james@gmail.com', '123-345-5678', 'James', 'Brown');
...
--
ALTER TABLE `Volunteer_Account`
  MODIFY `volunteer_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100004;
